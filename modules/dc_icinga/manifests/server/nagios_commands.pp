...
class dc_icinga::server::nagios_commands {
  ...
  icinga::command { 'check_mongodb':
    command_line => "/usr/lib/nagios/plugins/check_mongodb.py $mongodb_monitor_user -p $mongodb_monitor_password -H \$HOSTADDRESS$ -A \$ARG1$ -P \$ARG2$ -W \$ARG3$ -C \$ARG4$",
  }

  icinga::command { 'check_mongodb_alias':
    command_line => "/usr/lib/nagios/plugins/check_mongodb.py $mongodb_monitor_user -p $mongodb_monitor_password -H \$HOSTALIAS$ -A \$ARG1$ -P \$ARG2$ -W \$ARG3$ -C \$ARG4$",
  }

  icinga::command { 'check_mongodb_database':
    command_line => "/usr/lib/nagios/plugins/check_mongodb.py $mongodb_monitor_user -p $mongodb_monitor_password -H \$HOSTADDRESS$ -A \$ARG1$ -P \$ARG2$ -W \$ARG3$ -C \$ARG4$ -d \$ARG5$",
  }

  icinga::command { 'check_mongodb_collection':
    command_line => "/usr/lib/nagios/plugins/check_mongodb.py $mongodb_monitor_user -p $mongodb_monitor_password -H \$HOSTADDRESS$ -A \$ARG1$ -P \$ARG2$ -W \$ARG3$ -C \$ARG4$ -d \$ARG5$ -c \$ARG6$",
  }

  icinga::command { 'check_mongodb_replicaset':
    command_line => "/usr/lib/nagios/plugins/check_mongodb.py $mongodb_monitor_user -p $mongodb_monitor_password -H \$HOSTADDRESS$ -A \$ARG1$ -P \$ARG2$ -W \$ARG3$ -C \$ARG4$ -r \$ARG5$",
  }
