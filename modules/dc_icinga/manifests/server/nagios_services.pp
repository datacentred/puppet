...
class dc_icinga::server::nagios_services {
  ...
  icinga::service { 'check_ceph_health':
    ...
    check_command       => 'check_nrpe_1arg_with_timeout!check_ceph_health!120',
  ...
  icinga::service { 'check_ceph_mon':
    use                 => 'dc_service_generic',
    hostgroup_name      => 'dc_hostgroup_ceph_mon',
    check_command       => 'check_nrpe_1arg_with_timeout!check_ceph_mon!120',
  ...
  icinga::service { 'check_ceph_osd':
    ...
    check_command       => 'check_nrpe_1arg_with_timeout!check_ceph_osd!120',
  ...
  icinga::service { 'check_ceph_rgw':
    ...
    check_command       => 'check_nrpe_1arg_with_timeout!check_ceph_rgw!120',
  ...
  icinga::service { 'check_mongo_flush_average':
    use                 => 'dc_service_secondary',
    hostgroup_name      => 'dc_hostgroup_mongodb',
    check_command       => 'check_mongodb_dc!flushing!27017!30000!50000',
  ...
  icinga::service { 'check_mongo_last_flush':
    use                 => 'dc_service_secondary',
    hostgroup_name      => 'dc_hostgroup_mongodb',
    check_command       => 'check_mongodb_dc!last_flush_time!27017!30000!50000',
  ...
  icinga::service { 'check_psu_supermicro_x9':
    use                 => 'dc_service_generic',
    hostgroup_name      => 'dc_hostgroup_supermicro_x9',
    check_command       => 'check_nrpe_1arg!check_psu_supermicro_x9',
